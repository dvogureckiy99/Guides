...
- Распакуйте архив **ChibiStudio_v0.7.z** - это "урезанная" версия ChibiStudio, в ней меньше папочек, а именно: 
...
1. Настройка Workspace - укажите путь до своей папки workspace (в которой вы будете работать).
...
1. File - Import - General - Existing Prjects into Workspace  - **Next** 
...
> Если создаёте c - файл или cpp - файл, то добавить его нужно в переменную `PROJECT_CSRS` 

<p align="center">
<img src="eclipse_stm_pics/fig16.PNG">
</p>

> Переменная `PROJECT_INCDIR` содержит заголовочные файлы 

<p align="center">
<img src="eclipse_stm_pics/fig17.PNG">
</p>
